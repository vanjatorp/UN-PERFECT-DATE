...
A deployed link to the website can be found **[here](https://vanjatorp.github.io/UN-PERFECT-DATE/)**.
...
### Project Creation
Navigate to the **[template](https://github.com/Code-Institute-Org/gitpod-full-template)** and click 'Use this template'. Put in Repository name ((UN)PERFECT DATE) and check the Include all branches checkbox. Then navigate to the new **[repository](https://github.com/vanjatorp/-UN-PERFECT-DATE)**.
...
2. Go to repositories and select the one associated with this project: **[(UN)PERFECT DATE](https://github.com/vanjatorp/UN-PERFECT-DATE)**.
...
The live link for the site is here: **[https://vtwin90.github.io/UN-PERFECT-DATE/](https://vanjatorp.github.io/UN-PERFECT-DATE/)**

### **Create a local clone**

1. Open GitHub and navigate to repository **[here](https://github.com/vanjatorp/UN-PERFECT-DATE)**.
...
1. Navigate to the GitHub Repository you want to **[fork](https://github.com/vanjatorp/UN-PERFECT-DATE)**.
